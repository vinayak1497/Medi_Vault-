      ...
      if (updatedUser?.emailVerified == true) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                '✅ Email verified! Redirecting to doctor dashboard...',
              ),
          ...
          // Auto redirect to doctor dashboard after a short delay
          Future.delayed(const Duration(seconds: 2), () {
            if (mounted) {
              // Navigate to doctor dashboard and clear all previous routes
