...
class _SignupScreenState extends State<SignupScreen>
  ...
  Future<void> _signUp() async {
    ...
    try {
      // Capture the original doctor's UID if this is a doctor-initiated patient registration
      String? originalDoctorUid;
      if (widget.returnToDoctorDashboard) {
        final currentUser = FirebaseAuth.instance.currentUser;
        originalDoctorUid = currentUser?.uid;
      }
